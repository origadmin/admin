...
func (x *SourcePage) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_helpers_resp_data_v1_data_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x07, 0x63, 0x75, 0x72, 0x72, 0x65,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x3a, 0x0a, 0x0a, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x39, 0x0a, 0x09, 0x42, 0x79, 0x74, 0x65, 0x73,
...
var file_helpers_resp_data_v1_data_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_helpers_resp_data_v1_data_proto_goTypes = []any{
	...
	(*StringData)(nil),      // 4: data.v1.StringData
	(*BytesData)(nil),       // 5: data.v1.BytesData
	(*Token)(nil),           // 6: data.v1.Token
	(*AnyData)(nil),         // 7: data.v1.AnyData
	nil,                     // 8: data.v1.Page.ExtraEntry
	nil,                     // 9: data.v1.Data.ExtraEntry
	(*anypb.Any)(nil),       // 10: google.protobuf.Any
	(*structpb.Value)(nil),  // 11: google.protobuf.Value
	(*structpb.Struct)(nil), // 12: google.protobuf.Struct
}
var file_helpers_resp_data_v1_data_proto_depIdxs = []int32{
	10, // 0: data.v1.Page.data:type_name -> google.protobuf.Any
	8,  // 1: data.v1.Page.extra:type_name -> data.v1.Page.ExtraEntry
	11, // 2: data.v1.Page.value:type_name -> google.protobuf.Value
	12, // 3: data.v1.Page.struct:type_name -> google.protobuf.Struct
	10, // 4: data.v1.Data.data:type_name -> google.protobuf.Any
	9,  // 5: data.v1.Data.extra:type_name -> data.v1.Data.ExtraEntry
	2,  // 6: data.v1.Data.error:type_name -> data.v1.Error
	10, // 7: data.v1.AnyData.value:type_name -> google.protobuf.Any
	12, // 8: data.v1.Page.ExtraEntry.value:type_name -> google.protobuf.Struct
	10, // 9: data.v1.Data.ExtraEntry.value:type_name -> google.protobuf.Any
