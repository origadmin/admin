...
//
// Service MeService provides APIs for currently authenticated user to manage their own profile and data.
...
var MeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.services.identity.MeService",
