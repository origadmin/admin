...
const MeServiceListMyViewsBridgeOperation = "/api.v1.services.identity.MeService/ListMyViews"
const MeServiceGetProfileBridgeOperation = "/api.v1.services.identity.MeService/GetProfile"
const MeServiceUpdateProfileBridgeOperation = "/api.v1.services.identity.MeService/UpdateProfile"
...
type MeServiceBridgeServer interface {
	...
	// GetProfile retrieves profile of currently authenticated user.
	GetProfile(context.Context, *GetProfileRequest) (*GetProfileResponse, error)
	// UpdateProfile updates profile of currently authenticated user.
	UpdateProfile(context.Context, *UpdateProfileRequest) (*UpdateProfileResponse, error)
	// UpdatePassword changes password for currently authenticated user.
	UpdatePassword(context.Context, *UpdatePasswordRequest) (*UpdatePasswordResponse, error)
	// GetUserResources retrieves menu/resource list for current user.
