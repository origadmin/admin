...
const (
	PersonalService_GetPersonalProfile_FullMethodName     = "/api.v1.services.auth.PersonalService/GetPersonalProfile"
	PersonalService_ListPersonalResources_FullMethodName  = "/api.v1.services.auth.PersonalService/ListPersonalResources"
	PersonalService_ListPersonalRoles_FullMethodName      = "/api.v1.services.auth.PersonalService/ListPersonalRoles"
	PersonalService_PersonalLogout_FullMethodName         = "/api.v1.services.auth.PersonalService/PersonalLogout"
	PersonalService_RefreshPersonalToken_FullMethodName   = "/api.v1.services.auth.PersonalService/RefreshPersonalToken"
	PersonalService_UpdatePersonalPassword_FullMethodName = "/api.v1.services.auth.PersonalService/UpdatePersonalPassword"
	PersonalService_UpdatePersonalProfile_FullMethodName  = "/api.v1.services.auth.PersonalService/UpdatePersonalProfile"
	PersonalService_UpdatePersonalSetting_FullMethodName  = "/api.v1.services.auth.PersonalService/UpdatePersonalSetting"
)
...
var PersonalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.services.auth.PersonalService",
