...
type TokenRefreshResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         *v1.TokenCredential    `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TokenRefreshResponse) GetToken() *v1.TokenCredential {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *LoginResponse) GetToken() *v1.TokenCredential {
	if x != nil {
		return x.Token
	}
	return nil
...
const file_auth_login_proto_rawDesc = "" +
	...
	"LoginProtoP\x01Z5origadmin/application/admin/api/v1/services/auth;auth\xa2\x02\x04AVSA\xaa\x02\x14Api.V1.Services.Auth\xca\x02\x14Api\\V1\\Services\\Auth\xe2\x02 Api\\V1\\Services\\Auth\\GPBMetadata\xea\x02\x17Api::V1::Services::Authb\x06proto3"
...
var file_auth_login_proto_goTypes = []any{
	...
	(*v1.TokenCredential)(nil),       // 26: contrib.api.security.v1.TokenCredential
...
var file_auth_login_proto_depIdxs = []int32{
	...
	26, // 1: api.v1.services.auth.TokenRefreshResponse.token:type_name -> contrib.api.security.v1.TokenCredential
	21, // 2: api.v1.services.auth.LoginRequest.data:type_name -> api.v1.services.auth.LoginRequest.Data
	26, // 3: api.v1.services.auth.LoginResponse.token:type_name -> contrib.api.security.v1.TokenCredential
