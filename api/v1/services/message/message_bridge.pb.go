...
const PersonalServiceGetPersonalProfileBridgeOperation = "/api.v1.services.message.PersonalService/GetPersonalProfile"
const PersonalServiceListPersonalResourcesBridgeOperation = "/api.v1.services.message.PersonalService/ListPersonalResources"
const PersonalServiceListPersonalRolesBridgeOperation = "/api.v1.services.message.PersonalService/ListPersonalRoles"
const PersonalServicePersonalLogoutBridgeOperation = "/api.v1.services.message.PersonalService/PersonalLogout"
const PersonalServiceRefreshPersonalTokenBridgeOperation = "/api.v1.services.message.PersonalService/RefreshPersonalToken"
const PersonalServiceUpdatePersonalPasswordBridgeOperation = "/api.v1.services.message.PersonalService/UpdatePersonalPassword"
const PersonalServiceUpdatePersonalProfileBridgeOperation = "/api.v1.services.message.PersonalService/UpdatePersonalProfile"
const PersonalServiceUpdatePersonalSettingBridgeOperation = "/api.v1.services.message.PersonalService/UpdatePersonalSetting"
...
func RegisterPersonalServiceBridgeServer(s *http.Server, srv PersonalServiceHookedBridger) {
	...
	r.POST("/message/personal/logout", _PersonalService_PersonalLogout0_Bridge_Handler(srv))
	r.POST("/message/personal/token/refresh", _PersonalService_RefreshPersonalToken0_Bridge_Handler(srv))
	r.PUT("/message/personal/password", _PersonalService_UpdatePersonalPassword0_Bridge_Handler(srv))
	r.PUT("/message/personal/profile", _PersonalService_UpdatePersonalProfile0_Bridge_Handler(srv))
	r.PUT("/message/personal/setting", _PersonalService_UpdatePersonalSetting0_Bridge_Handler(srv))
}
