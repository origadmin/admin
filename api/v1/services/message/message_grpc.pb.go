...
const (
	PersonalService_GetPersonalProfile_FullMethodName     = "/api.v1.services.message.PersonalService/GetPersonalProfile"
	PersonalService_ListPersonalResources_FullMethodName  = "/api.v1.services.message.PersonalService/ListPersonalResources"
	PersonalService_ListPersonalRoles_FullMethodName      = "/api.v1.services.message.PersonalService/ListPersonalRoles"
	PersonalService_PersonalLogout_FullMethodName         = "/api.v1.services.message.PersonalService/PersonalLogout"
	PersonalService_RefreshPersonalToken_FullMethodName   = "/api.v1.services.message.PersonalService/RefreshPersonalToken"
	PersonalService_UpdatePersonalPassword_FullMethodName = "/api.v1.services.message.PersonalService/UpdatePersonalPassword"
	PersonalService_UpdatePersonalProfile_FullMethodName  = "/api.v1.services.message.PersonalService/UpdatePersonalProfile"
	PersonalService_UpdatePersonalSetting_FullMethodName  = "/api.v1.services.message.PersonalService/UpdatePersonalSetting"
)
...
var PersonalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.services.message.PersonalService",
