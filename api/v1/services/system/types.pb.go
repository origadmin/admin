...
const file_system_types_proto_rawDesc = "" +
	"\n" +
	...
	"TypesProtoP\x01Z\x19v1/services/system;system\xa2\x02\x04AVSS\xaa\x02\x16Api.V1.Services.System\xca\x02\x16Api\\V1\\Services\\System\xe2\x02\"Api\\V1\\Services\\System\\GPBMetadata\xea\x02\x19Api::V1::Services::Systemb\x06proto3"

var (
	file_system_types_proto_rawDescOnce sync.Once
	file_system_types_proto_rawDescData []byte
)

func file_system_types_proto_rawDescGZIP() []byte {
	file_system_types_proto_rawDescOnce.Do(func() {
		file_system_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_system_types_proto_rawDesc), len(file_system_types_proto_rawDesc)))
	})
...
func file_system_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_system_types_proto_rawDesc), len(file_system_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   30,
			NumExtensions: 0,
			NumServices:   0,
