...
const file_system_position_proto_rawDesc = "" +
	...
	"\x0fPositionService\x12\x8f\x01\n" +
	"\rListPositions\x12,.api.v1.services.system.ListPositionsRequest\x1a-.api.v1.services.system.ListPositionsResponse\"!\xea\xea\x1b\a\n" +
	"\x05authz\x82\xd3\xe4\x93\x02\x10\x12\x0e/sys/positions\x12\x8e\x01\n" +
	"\vGetPosition\x12*.api.v1.services.system.GetPositionRequest\x1a+.api.v1.services.system.GetPositionResponse\"&\xea\xea\x1b\a\n" +
	"\x05authz\x82\xd3\xe4\x93\x02\x15\x12\x13/sys/positions/{id}\x12\x95\x01\n" +
	"\x0eCreatePosition\x12-.api.v1.services.system.CreatePositionRequest\x1a..api.v1.services.system.CreatePositionResponse\"$\xea\xea\x1b\a\n" +
	"\x05authz\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/sys/positions\x12\xa3\x01\n" +
	"\x0eUpdatePosition\x12-.api.v1.services.system.UpdatePositionRequest\x1a..api.v1.services.system.UpdatePositionResponse\"2\xea\xea\x1b\a\n" +
	"\x05authz\x82\xd3\xe4\x93\x02!:\x01*\x1a\x1c/sys/positions/{position.id}\x12\x97\x01\n" +
	"\x0eDeletePosition\x12-.api.v1.services.system.DeletePositionRequest\x1a..api.v1.services.system.DeletePositionResponse\"&\xea\xea\x1b\a\n" +
	"\x05authz\x82\xd3\xe4\x93\x02\x15*\x13/sys/positions/{id}B\xe2\x01\n" +
