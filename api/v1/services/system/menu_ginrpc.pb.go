...
type MenuAPIGINRPCServer interface {
	CreateMenu(*gin.Context, *CreateMenuRequest)
	DeleteMenu(*gin.Context, *DeleteMenuRequest)
	GetMenu(*gin.Context, *GetMenuRequest)
	ListMenus(*gin.Context, *ListMenusRequest)
	UpdateMenu(*gin.Context, *UpdateMenuRequest)
}

func RegisterMenuAPIGINRPCServer(router gins.IRouter, srv MenuAPIGINRPCServer) {
...
func _MenuAPI_ListMenus0_GINRPC_Handler(srv MenuAPIGINRPCServer) func(ctx *gins.Context) {
...
func _MenuAPI_GetMenu0_GINRPC_Handler(srv MenuAPIGINRPCServer) func(ctx *gins.Context) {
	return func(ctx *gins.Context) {
...
func _MenuAPI_CreateMenu0_GINRPC_Handler(srv MenuAPIGINRPCServer) func(ctx *gins.Context) {
	return func(ctx *gins.Context) {
...
func _MenuAPI_UpdateMenu0_GINRPC_Handler(srv MenuAPIGINRPCServer) func(ctx *gins.Context) {
	return func(ctx *gins.Context) {
...
func _MenuAPI_DeleteMenu0_GINRPC_Handler(srv MenuAPIGINRPCServer) func(ctx *gins.Context) {
	return func(ctx *gins.Context) {
