...
const OperationPositionServiceCreatePosition = "/api.v1.services.organization.PositionService/CreatePosition"
const OperationPositionServiceDeletePosition = "/api.v1.services.organization.PositionService/DeletePosition"
const OperationPositionServiceGetPosition = "/api.v1.services.organization.PositionService/GetPosition"
const OperationPositionServiceListPositions = "/api.v1.services.organization.PositionService/ListPositions"
const OperationPositionServiceUpdatePosition = "/api.v1.services.organization.PositionService/UpdatePosition"
...
func RegisterPositionServiceHTTPServer(s *http.Server, srv PositionServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/org/positions", _PositionService_ListPositions0_HTTP_Handler(srv))
	r.GET("/org/positions/{id}", _PositionService_GetPosition0_HTTP_Handler(srv))
	r.POST("/org/positions", _PositionService_CreatePosition0_HTTP_Handler(srv))
	r.PUT("/org/positions/{position.id}", _PositionService_UpdatePosition0_HTTP_Handler(srv))
	r.DELETE("/org/positions/{id}", _PositionService_DeletePosition0_HTTP_Handler(srv))
}
...
func (c *PositionServiceHTTPClientImpl) UpdatePosition(ctx context.Context, in *UpdatePositionRequest, opts ...http.CallOption) (*UpdatePositionResponse, error) {
	...
	pattern := "/org/positions/{position.id}"
	path := binding.EncodeURL(pattern, in, false)
