...
const PositionServiceListPositionsBridgeOperation = "/api.v1.services.organization.PositionService/ListPositions"
const PositionServiceGetPositionBridgeOperation = "/api.v1.services.organization.PositionService/GetPosition"
const PositionServiceCreatePositionBridgeOperation = "/api.v1.services.organization.PositionService/CreatePosition"
const PositionServiceUpdatePositionBridgeOperation = "/api.v1.services.organization.PositionService/UpdatePosition"
const PositionServiceDeletePositionBridgeOperation = "/api.v1.services.organization.PositionService/DeletePosition"
...
func RegisterPositionServiceBridgeServer(s *http.Server, srv PositionServiceHookedBridger) {
	r := s.Route("/")
	r.GET("/org/positions", _PositionService_ListPositions0_Bridge_Handler(srv))
	r.GET("/org/positions/:id", _PositionService_GetPosition0_Bridge_Handler(srv))
	r.POST("/org/positions", _PositionService_CreatePosition0_Bridge_Handler(srv))
	r.PUT("/org/positions/:position.id", _PositionService_UpdatePosition0_Bridge_Handler(srv))
	r.DELETE("/org/positions/:id", _PositionService_DeletePosition0_Bridge_Handler(srv))
}
