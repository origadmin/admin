...
const DepartmentServiceListDepartmentsBridgeOperation = "/api.v1.services.organization.DepartmentService/ListDepartments"
const DepartmentServiceGetDepartmentBridgeOperation = "/api.v1.services.organization.DepartmentService/GetDepartment"
const DepartmentServiceCreateDepartmentBridgeOperation = "/api.v1.services.organization.DepartmentService/CreateDepartment"
const DepartmentServiceUpdateDepartmentBridgeOperation = "/api.v1.services.organization.DepartmentService/UpdateDepartment"
const DepartmentServiceDeleteDepartmentBridgeOperation = "/api.v1.services.organization.DepartmentService/DeleteDepartment"
...
func RegisterDepartmentServiceBridgeServer(s *http.Server, srv DepartmentServiceHookedBridger) {
	r := s.Route("/")
	r.GET("/org/departments", _DepartmentService_ListDepartments0_Bridge_Handler(srv))
	r.GET("/org/departments/:id", _DepartmentService_GetDepartment0_Bridge_Handler(srv))
	r.POST("/org/departments", _DepartmentService_CreateDepartment0_Bridge_Handler(srv))
	r.PUT("/org/departments/:department.id", _DepartmentService_UpdateDepartment0_Bridge_Handler(srv))
	r.DELETE("/org/departments/:id", _DepartmentService_DeleteDepartment0_Bridge_Handler(srv))
}
