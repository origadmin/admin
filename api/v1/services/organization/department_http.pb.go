...
const OperationDepartmentServiceCreateDepartment = "/api.v1.services.organization.DepartmentService/CreateDepartment"
const OperationDepartmentServiceDeleteDepartment = "/api.v1.services.organization.DepartmentService/DeleteDepartment"
const OperationDepartmentServiceGetDepartment = "/api.v1.services.organization.DepartmentService/GetDepartment"
const OperationDepartmentServiceListDepartments = "/api.v1.services.organization.DepartmentService/ListDepartments"
const OperationDepartmentServiceUpdateDepartment = "/api.v1.services.organization.DepartmentService/UpdateDepartment"
...
func RegisterDepartmentServiceHTTPServer(s *http.Server, srv DepartmentServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/org/departments", _DepartmentService_ListDepartments0_HTTP_Handler(srv))
	r.GET("/org/departments/{id}", _DepartmentService_GetDepartment0_HTTP_Handler(srv))
	r.POST("/org/departments", _DepartmentService_CreateDepartment0_HTTP_Handler(srv))
	r.PUT("/org/departments/{department.id}", _DepartmentService_UpdateDepartment0_HTTP_Handler(srv))
	r.DELETE("/org/departments/{id}", _DepartmentService_DeleteDepartment0_HTTP_Handler(srv))
}
...
func (c *DepartmentServiceHTTPClientImpl) UpdateDepartment(ctx context.Context, in *UpdateDepartmentRequest, opts ...http.CallOption) (*UpdateDepartmentResponse, error) {
	...
	pattern := "/org/departments/{department.id}"
	path := binding.EncodeURL(pattern, in, false)
