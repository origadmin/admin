...
// Validate checks the field values on DownloadObjectRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *DownloadObjectRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DownloadObjectRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DownloadObjectRequestMultiError, or nil if none found.
func (m *DownloadObjectRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *DownloadObjectRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// DownloadObjectRequestMultiError is an error wrapping multiple validation
// errors returned by DownloadObjectRequest.ValidateAll() if the designated
// constraints aren't met.
type DownloadObjectRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DownloadObjectRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DownloadObjectRequestMultiError) AllErrors() []error { return m }

// DownloadObjectRequestValidationError is the validation error returned by
// DownloadObjectRequest.Validate if the designated constraints aren't met.
type DownloadObjectRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DownloadObjectRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DownloadObjectRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DownloadObjectRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DownloadObjectRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DownloadObjectRequestValidationError) ErrorName() string {
	return "DownloadObjectRequestValidationError"
}

// Error satisfies the builtin error interface
func (e DownloadObjectRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDownloadObjectRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DownloadObjectRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DownloadObjectRequestValidationError{}
