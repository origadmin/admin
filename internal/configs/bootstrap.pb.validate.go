...
// Validate checks the field values on Server_Cors with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *Server_Cors) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Server_Cors with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in Server_CorsMultiError, or
// nil if none found.
func (m *Server_Cors) ValidateAll() error {
	return m.validate(true)
}

func (m *Server_Cors) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Server_CorsMultiError(errors)
	}

	return nil
}

// Server_CorsMultiError is an error wrapping multiple validation errors
// returned by Server_Cors.ValidateAll() if the designated constraints aren't met.
type Server_CorsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Server_CorsMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Server_CorsMultiError) AllErrors() []error { return m }

// Server_CorsValidationError is the validation error returned by
// Server_Cors.Validate if the designated constraints aren't met.
type Server_CorsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Server_CorsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Server_CorsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Server_CorsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Server_CorsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Server_CorsValidationError) ErrorName() string { return "Server_CorsValidationError" }

// Error satisfies the builtin error interface
func (e Server_CorsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = Server_CorsValidationError{}
