...
const (
	// Label holds the string label denoting the menuresource type in the database.
	Label = "menu_resource"
	...
	EdgeMenu = "menu"
	// Table holds the table name of the menuresource in the database.
	Table = "sys_menu_resources"
	// MenuTable is the table that holds the menu relation/edge.
	MenuTable = "sys_menu_resources"
...
// Columns holds all SQL columns for menuresource fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the MenuResource queries.
