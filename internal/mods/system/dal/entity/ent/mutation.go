...
// ClearResources clears the "resources" edge to the MenuResource entity.
func (m *MenuMutation) ClearResources() {
	m.clearedresources = true
}

// ResourcesCleared reports if the "resources" edge to the MenuResource entity was cleared.
func (m *MenuMutation) ResourcesCleared() bool {
	return m.clearedresources
}

// RemoveResourceIDs removes the "resources" edge to the MenuResource entity by IDs.
...
// RemovedResources returns the removed IDs of the "resources" edge to the MenuResource entity.
...
// MenuResourceMutation represents an operation that mutates the MenuResource nodes in the graph.
type MenuResourceMutation struct {
	config
	op            Op
	typ           string
	id            *string
	...
	oldValue      func(context.Context) (*MenuResource, error)
	predicates    []predicate.MenuResource
}

var _ ent.Mutation = (*MenuResourceMutation)(nil)

// menuresourceOption allows management of the mutation configuration using functional options.
type menuresourceOption func(*MenuResourceMutation)

// newMenuResourceMutation creates new mutation for the MenuResource entity.
func newMenuResourceMutation(c config, op Op, opts ...menuresourceOption) *MenuResourceMutation {
	m := &MenuResourceMutation{
		config:        c,
		op:            op,
		typ:           TypeMenuResource,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withMenuResourceID sets the ID field of the mutation.
func withMenuResourceID(id string) menuresourceOption {
	return func(m *MenuResourceMutation) {
		var (
			err   error
			once  sync.Once
			value *MenuResource
		)
		m.oldValue = func(ctx context.Context) (*MenuResource, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().MenuResource.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withMenuResource sets the old MenuResource of the mutation.
func withMenuResource(node *MenuResource) menuresourceOption {
	return func(m *MenuResourceMutation) {
		m.oldValue = func(context.Context) (*MenuResource, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m MenuResourceMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m MenuResourceMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of MenuResource entities.
func (m *MenuResourceMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MenuResourceMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MenuResourceMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().MenuResource.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreateTime sets the "create_time" field.
func (m *MenuResourceMutation) SetCreateTime(t time.Time) {
	m.create_time = &t
}

// CreateTime returns the value of the "create_time" field in the mutation.
func (m *MenuResourceMutation) CreateTime() (r time.Time, exists bool) {
	v := m.create_time
	if v == nil {
		return
	}
...
// OldCreateTime returns the old "create_time" field's value of the MenuResource entity.
// If the MenuResource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MenuResourceMutation) OldCreateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreateTime resets all changes to the "create_time" field.
func (m *MenuResourceMutation) ResetCreateTime() {
	m.create_time = nil
}

// SetUpdateTime sets the "update_time" field.
func (m *MenuResourceMutation) SetUpdateTime(t time.Time) {
	m.update_time = &t
}

// UpdateTime returns the value of the "update_time" field in the mutation.
func (m *MenuResourceMutation) UpdateTime() (r time.Time, exists bool) {
	v := m.update_time
	if v == nil {
		return
	}
...
// OldUpdateTime returns the old "update_time" field's value of the MenuResource entity.
// If the MenuResource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MenuResourceMutation) OldUpdateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdateTime resets all changes to the "update_time" field.
func (m *MenuResourceMutation) ResetUpdateTime() {
	m.update_time = nil
}

// SetMenuID sets the "menu_id" field.
func (m *MenuResourceMutation) SetMenuID(s string) {
	m.menu = &s
}

// MenuID returns the value of the "menu_id" field in the mutation.
func (m *MenuResourceMutation) MenuID() (r string, exists bool) {
	v := m.menu
	if v == nil {
		return
	}
...
// OldMenuID returns the old "menu_id" field's value of the MenuResource entity.
// If the MenuResource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MenuResourceMutation) OldMenuID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MenuResourceMutation) ClearMenuID() {
	m.menu = nil
	m.clearedFields[menuresource.FieldMenuID] = struct{}{}
}

// MenuIDCleared returns if the "menu_id" field was cleared in this mutation.
func (m *MenuResourceMutation) MenuIDCleared() bool {
	_, ok := m.clearedFields[menuresource.FieldMenuID]
	return ok
}

// ResetMenuID resets all changes to the "menu_id" field.
func (m *MenuResourceMutation) ResetMenuID() {
	m.menu = nil
	delete(m.clearedFields, menuresource.FieldMenuID)
}

// SetMethod sets the "method" field.
func (m *MenuResourceMutation) SetMethod(s string) {
	m.method = &s
}

// Method returns the value of the "method" field in the mutation.
func (m *MenuResourceMutation) Method() (r string, exists bool) {
	v := m.method
	if v == nil {
		return
	}
...
// OldMethod returns the old "method" field's value of the MenuResource entity.
// If the MenuResource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MenuResourceMutation) OldMethod(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MenuResourceMutation) ResetMethod() {
	m.method = nil
}

// SetPath sets the "path" field.
func (m *MenuResourceMutation) SetPath(s string) {
	m._path = &s
}

// Path returns the value of the "path" field in the mutation.
func (m *MenuResourceMutation) Path() (r string, exists bool) {
	v := m._path
	if v == nil {
		return
	}
...
// OldPath returns the old "path" field's value of the MenuResource entity.
// If the MenuResource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MenuResourceMutation) OldPath(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPath is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPath resets all changes to the "path" field.
func (m *MenuResourceMutation) ResetPath() {
	m._path = nil
}

// ClearMenu clears the "menu" edge to the Menu entity.
func (m *MenuResourceMutation) ClearMenu() {
	m.clearedmenu = true
	m.clearedFields[menuresource.FieldMenuID] = struct{}{}
}

// MenuCleared reports if the "menu" edge to the Menu entity was cleared.
func (m *MenuResourceMutation) MenuCleared() bool {
...
func (m *MenuResourceMutation) MenuIDs() (ids []string) {
	if id := m.menu; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *MenuResourceMutation) ResetMenu() {
	m.menu = nil
	m.clearedmenu = false
}

// Where appends a list predicates to the MenuResourceMutation builder.
func (m *MenuResourceMutation) Where(ps ...predicate.MenuResource) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the MenuResourceMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MenuResourceMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MenuResource, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *MenuResourceMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *MenuResourceMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (MenuResource).
func (m *MenuResourceMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *MenuResourceMutation) Fields() []string {
	fields := make([]string, 0, 5)
	if m.create_time != nil {
		fields = append(fields, menuresource.FieldCreateTime)
	}
	if m.update_time != nil {
		fields = append(fields, menuresource.FieldUpdateTime)
	}
	if m.menu != nil {
		fields = append(fields, menuresource.FieldMenuID)
	}
	if m.method != nil {
		fields = append(fields, menuresource.FieldMethod)
	}
	if m._path != nil {
		fields = append(fields, menuresource.FieldPath)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MenuResourceMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MenuResourceMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case menuresource.FieldCreateTime:
		return m.OldCreateTime(ctx)
	case menuresource.FieldUpdateTime:
	...
	return nil, fmt.Errorf("unknown MenuResource field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MenuResourceMutation) SetField(name string, value ent.Value) error {
	switch name {
	case menuresource.FieldCreateTime:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown MenuResource field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *MenuResourceMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MenuResourceMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MenuResourceMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown MenuResource numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *MenuResourceMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(menuresource.FieldMenuID) {
		fields = append(fields, menuresource.FieldMenuID)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *MenuResourceMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *MenuResourceMutation) ClearField(name string) error {
	switch name {
	case menuresource.FieldMenuID:
		m.ClearMenuID()
		return nil
	}
	return fmt.Errorf("unknown MenuResource nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *MenuResourceMutation) ResetField(name string) error {
	switch name {
	case menuresource.FieldCreateTime:
		m.ResetCreateTime()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *MenuResourceMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.menu != nil {
		edges = append(edges, menuresource.EdgeMenu)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MenuResourceMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case menuresource.EdgeMenu:
		if id := m.menu; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *MenuResourceMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MenuResourceMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *MenuResourceMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedmenu {
		edges = append(edges, menuresource.EdgeMenu)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *MenuResourceMutation) EdgeCleared(name string) bool {
	switch name {
	case menuresource.EdgeMenu:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *MenuResourceMutation) ClearEdge(name string) error {
	switch name {
	case menuresource.EdgeMenu:
		m.ClearMenu()
		return nil
	}
	return fmt.Errorf("unknown MenuResource unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *MenuResourceMutation) ResetEdge(name string) error {
	switch name {
	case menuresource.EdgeMenu:
		m.ResetMenu()
		return nil
	}
	return fmt.Errorf("unknown MenuResource edge %s", name)
}
...
// SetCreateTime sets the "create_time" field.
func (m *RoleMenuMutation) SetCreateTime(t time.Time) {
	m.create_time = &t
}

// CreateTime returns the value of the "create_time" field in the mutation.
func (m *RoleMenuMutation) CreateTime() (r time.Time, exists bool) {
	v := m.create_time
	if v == nil {
		return
	}
...
// OldCreateTime returns the old "create_time" field's value of the RoleMenu entity.
// If the RoleMenu object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoleMenuMutation) OldCreateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreateTime resets all changes to the "create_time" field.
func (m *RoleMenuMutation) ResetCreateTime() {
	m.create_time = nil
}

// SetUpdateTime sets the "update_time" field.
func (m *RoleMenuMutation) SetUpdateTime(t time.Time) {
	m.update_time = &t
}

// UpdateTime returns the value of the "update_time" field in the mutation.
func (m *RoleMenuMutation) UpdateTime() (r time.Time, exists bool) {
	v := m.update_time
	if v == nil {
		return
	}
...
// OldUpdateTime returns the old "update_time" field's value of the RoleMenu entity.
// If the RoleMenu object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoleMenuMutation) OldUpdateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdateTime resets all changes to the "update_time" field.
func (m *RoleMenuMutation) ResetUpdateTime() {
	m.update_time = nil
}
...
func (m *RoleMenuMutation) Fields() []string {
	...
	if m.create_time != nil {
		fields = append(fields, rolemenu.FieldCreateTime)
	}
	if m.update_time != nil {
		fields = append(fields, rolemenu.FieldUpdateTime)
	}
	if m.role != nil {
