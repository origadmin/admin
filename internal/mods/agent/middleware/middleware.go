...
func New(cfg *configv1.Middleware, opts ...Setting) gins.HandlerFunc {
	...
	authn := NewAuthN(cfg.GetSecurity(), option)
	authz := NewAuthZ(cfg.GetSecurity(), option)
...
func NewClient(cfg *configv1.Middleware, ss ...middleware.OptionSetting) []middleware.Middleware {
