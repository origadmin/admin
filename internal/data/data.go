...
func NewLoginData(cfg *configs.Bootstrap, tokenizer security.RefreshTokenizer) *LoginData {
	return &LoginData{
		Captcha:   cfg.GetSecurity().GetCaptcha(),
		RootUser:  cfg.GetSecurity().GetRootUser(),
		Tokenizer: tokenizer,
	}
}
