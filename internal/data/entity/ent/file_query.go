...
//
//	client.File.Query().
//		GroupBy(file.FieldCreateAuthor).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//	client.File.Query().
//	  Omit(
//	  file.FieldCreateAuthor,
//	  file.FieldUpdateAuthor,
//	  file.FieldCreateTime,
//	  file.FieldUpdateTime,
//	  file.FieldDeleteTime,
//	  file.FieldOwnerID,
//	  file.FieldName,
//	  file.FieldObjectID,
...
func (fq *FileQuery) Omit(fields ...string) *FileSelect {
	...
	for _, col := range file.Columns {
		if _, ok := omits[col]; !ok {
			fq.ctx.Fields = append(fq.ctx.Fields, col)
		}
	}
