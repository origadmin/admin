...
type (
	...
	config struct {
		...
		debug func(dialect.Driver, ...func(...any)) dialect.Driver
...
func (c *config) options(opts ...Option) {
	...
	if c.debug != nil {
		c.driver = c.debug(c.driver, c.log)
	}
}
...
func Debug() Option {
	return func(c *config) {
		c.debug = dialect.Debug
	}
}

// WithDebug configures the debug function.
func WithDebug(fn func(dialect.Driver, ...func(...any)) dialect.Driver) Option {
	return func(c *config) {
		c.debug = fn
	}
}
...
func (c *Client) Debug() *Client {
	...
	cfg := c.config
	cfg.driver = c.debug(c.driver, c.log)
