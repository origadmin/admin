...
func (_c *PositionCreate) SetCreateAuthor(v int64) *PositionCreate {
	_c.mutation.SetCreateAuthor(v)
	return _c
}

// SetNillableCreateAuthor sets the "create_author" field if the given value is not nil.
func (_c *PositionCreate) SetNillableCreateAuthor(v *int64) *PositionCreate {
	if v != nil {
...
func (_c *PositionCreate) SetUpdateAuthor(v int64) *PositionCreate {
	_c.mutation.SetUpdateAuthor(v)
	return _c
}

// SetNillableUpdateAuthor sets the "update_author" field if the given value is not nil.
func (_c *PositionCreate) SetNillableUpdateAuthor(v *int64) *PositionCreate {
	if v != nil {
...
func (_c *PositionCreate) defaults() error {
	if _, ok := _c.mutation.CreateTime(); !ok {
		if position.DefaultCreateTime == nil {
			return fmt.Errorf("ent: uninitialized position.DefaultCreateTime (forgotten import ent/runtime?)")
		}
		v := position.DefaultCreateTime()
		_c.mutation.SetCreateTime(v)
	}
	if _, ok := _c.mutation.UpdateTime(); !ok {
		if position.DefaultUpdateTime == nil {
			return fmt.Errorf("ent: uninitialized position.DefaultUpdateTime (forgotten import ent/runtime?)")
		}
...
func (_c *PositionCreate) createSpec() (*Position, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CreateAuthor(); ok {
		_spec.SetField(position.FieldCreateAuthor, field.TypeInt64, value)
