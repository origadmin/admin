...
var (
	...
	SysPermissionsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Comment: "entity.permission.field.status.comment", Enums: []string{"enabled", "disabled"}, Default: "enabled"},
	...
	SysResourcesColumns = []*schema.Column{
		...
		{Name: "create_time", Type: field.TypeTime, Comment: "create_time.field.comment"},
		{Name: "update_time", Type: field.TypeTime, Comment: "update_time.field.comment"},
		{Name: "service_name", Type: field.TypeString, Comment: "entity.resource.field.service_name.comment"},
		{Name: "keyword", Type: field.TypeString, Unique: true, Size: 255, Comment: "entity.resource.field.keyword.comment"},
		{Name: "path", Type: field.TypeString, Nullable: true, Comment: "entity.resource.field.path.comment"},
		{Name: "method", Type: field.TypeString, Nullable: true, Comment: "entity.resource.field.method.comment"},
		{Name: "operation", Type: field.TypeString, Nullable: true, Comment: "entity.resource.field.operation.comment"},
		{Name: "policy", Type: field.TypeString, Comment: "entity.resource.field.policy.comment", Default: ""},
		{Name: "version_id", Type: field.TypeString, Comment: "entity.resource.field.version_id.comment", Default: ""},
		{Name: "last_sync_version_id", Type: field.TypeString, Comment: "entity.resource.field.last_sync_version_id.comment", Default: ""},
		{Name: "sync_status", Type: field.TypeString, Comment: "entity.resource.field.sync_status.comment", Default: "Synced"},
		{Name: "status", Type: field.TypeEnum, Comment: "entity.resource.field.status.comment", Enums: []string{"enabled", "disabled"}, Default: "enabled"},
	}
	...
	SysViewsColumns = []*schema.Column{
		...
		{Name: "create_time", Type: field.TypeTime, Comment: "create_time.field.comment"},
		{Name: "update_time", Type: field.TypeTime, Comment: "update_time.field.comment"},
		{Name: "keyword", Type: field.TypeString, Unique: true, Size: 255, Comment: "entity.view.field.keyword.comment"},
		{Name: "scope", Type: field.TypeString, Comment: "entity.view.field.scope.comment", Default: "default"},
		{Name: "name", Type: field.TypeString, Comment: "entity.view.field.name.comment"},
		{Name: "type", Type: field.TypeEnum, Comment: "entity.view.field.type.comment", Enums: []string{"T", "G", "M", "L", "P", "B", "E", "R", "U"}, Default: "U"},
		{Name: "component", Type: field.TypeString, Nullable: true, Comment: "entity.view.field.component.comment"},
		{Name: "path", Type: field.TypeString, Nullable: true, Comment: "entity.view.field.path.comment"},
		{Name: "icon", Type: field.TypeString, Nullable: true, Comment: "entity.view.field.icon.comment"},
		{Name: "visible", Type: field.TypeBool, Comment: "entity.view.field.visible.comment", Default: true},
		{Name: "sequence", Type: field.TypeInt, Comment: "entity.view.field.sequence.comment", Default: 0},
		{Name: "tree_path", Type: field.TypeString, Nullable: true, Comment: "entity.view.field.tree_path.comment"},
		{Name: "parent_id", Type: field.TypeInt64, Nullable: true, Comment: "entity.view.field.parent_id.comment"},
	}
