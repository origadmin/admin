...
// entity.user_department.table.comment
...
func (_m *UserDepartment) assignValues(columns []string, values []any) error {
...
func (_m *UserDepartment) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryUser queries the "user" edge of the UserDepartment entity.
func (_m *UserDepartment) QueryUser() *UserQuery {
	return NewUserDepartmentClient(_m.config).QueryUser(_m)
}

// QueryDepartment queries the "department" edge of the UserDepartment entity.
func (_m *UserDepartment) QueryDepartment() *DepartmentQuery {
	return NewUserDepartmentClient(_m.config).QueryDepartment(_m)
}
...
func (_m *UserDepartment) Update() *UserDepartmentUpdateOne {
	return NewUserDepartmentClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the UserDepartment entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *UserDepartment) Unwrap() *UserDepartment {
...
func (_m *UserDepartment) String() string {
