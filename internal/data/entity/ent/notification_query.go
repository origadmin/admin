...
//		GroupBy(notification.FieldCreateAuthor).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Notification.Query().
//		Select(notification.FieldCreateAuthor).
//		Scan(ctx, &v)
...
//	client.Notification.Query().
//	  Omit(
//	  notification.FieldCreateAuthor,
//	  notification.FieldUpdateAuthor,
//	  notification.FieldCreateTime,
//	  notification.FieldUpdateTime,
//	  notification.FieldSubject,
//	  notification.FieldContent,
//	  notification.FieldStatus,
//	  notification.FieldCategoryID,
//	  ).
//	  Scan(ctx, &v)
func (nq *NotificationQuery) Omit(fields ...string) *NotificationSelect {
	...
	for _, col := range notification.Columns {
		if _, ok := omits[col]; !ok {
			nq.ctx.Fields = append(nq.ctx.Fields, col)
		}
	}
