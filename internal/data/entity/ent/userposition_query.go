...
func (_q *UserPositionQuery) QueryUser() *UserQuery {
...
func (_q *UserPositionQuery) QueryPosition() *PositionQuery {
...
func (_q *UserPositionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserPositionQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserPositionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserPositionQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserPositionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserPositionQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserPositionQuery) WithUser(opts ...func(*UserQuery)) *UserPositionQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserPositionQuery) WithPosition(opts ...func(*PositionQuery)) *UserPositionQuery {
	query := (&PositionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserPositionQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserPosition, init func(*UserPosition), assign func(*UserPosition, *User)) error {
...
func (_q *UserPositionQuery) loadPosition(ctx context.Context, query *PositionQuery, nodes []*UserPosition, init func(*UserPosition), assign func(*UserPosition, *Position)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*UserPosition)
	for i := range nodes {
