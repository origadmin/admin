...
func (_q *PositionQuery) QueryDepartment() *DepartmentQuery {
...
func (_q *PositionQuery) QueryPermissions() *PermissionQuery {
...
func (_q *PositionQuery) QueryUserPositions() *UserPositionQuery {
	query := (&UserPositionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PositionQuery) QueryPositionPermissions() *PositionPermissionQuery {
	query := (&PositionPermissionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PositionQuery) Clone() *PositionQuery {
	...
	return &PositionQuery{
		...
		withUserPositions:       _q.withUserPositions.Clone(),
...
func (_q *PositionQuery) WithDepartment(opts ...func(*DepartmentQuery)) *PositionQuery {
	query := (&DepartmentClient{config: _q.config}).Query()
...
func (_q *PositionQuery) WithPermissions(opts ...func(*PermissionQuery)) *PositionQuery {
	query := (&PermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PositionQuery) WithUserPositions(opts ...func(*UserPositionQuery)) *PositionQuery {
	query := (&UserPositionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withUserPositions = query
	return _q
}
...
func (_q *PositionQuery) WithPositionPermissions(opts ...func(*PositionPermissionQuery)) *PositionQuery {
	query := (&PositionPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withPositionPermissions = query
	return _q
}
...
func (_q *PositionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Position, error) {
	...
	if query := _q.withUserPositions; query != nil {
		if err := _q.loadUserPositions(ctx, query, nodes,
	...
	if query := _q.withPositionPermissions; query != nil {
		if err := _q.loadPositionPermissions(ctx, query, nodes,
...
func (_q *PositionQuery) loadDepartment(ctx context.Context, query *DepartmentQuery, nodes []*Position, init func(*Position), assign func(*Position, *Department)) error {
...
func (_q *PositionQuery) loadPermissions(ctx context.Context, query *PermissionQuery, nodes []*Position, init func(*Position), assign func(*Position, *Permission)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Position)
	nids := make(map[int64]map[*Position]struct{})
	for i, node := range nodes {
...
func (_q *PositionQuery) loadUserPositions(ctx context.Context, query *UserPositionQuery, nodes []*Position, init func(*Position), assign func(*Position, *UserPosition)) error {
...
func (_q *PositionQuery) loadPositionPermissions(ctx context.Context, query *PositionPermissionQuery, nodes []*Position, init func(*Position), assign func(*Position, *PositionPermission)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Position)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
