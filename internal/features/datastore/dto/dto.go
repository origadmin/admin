...
var (
	...
	ErrUserNotFound      = errors.New(http.errors"http.response.status."+typespb.SystemErrorReason_SYSTEM_ERROR_REASON_USER_NOT_FOUND.String(), http.StatusNotFound, "user not found")
	ErrInvalidCaptchaID  = errors.New(http.errors"http.response.status."+typespb.SystemErrorReason_SYSTEM_ERROR_REASON_INVALID_CAPTCHA_ID.String(), http.StatusBadRequest, "invalid captcha id")
	ErrInvalidPassword   = errors.New(http.errors"http.response.status."+typespb.SystemErrorReason_SYSTEM_ERROR_REASON_INVALID_PASSWORD.String(), http.StatusBadRequest, "invalid password")
	ErrInvalidUsername   = errors.New(http.errors"http.response.status."+typespb.SystemErrorReason_SYSTEM_ERROR_REASON_INVALID_USERNAME.String(), http.StatusBadRequest, "invalid username")
	ErrCaptchaIDNotFound = errors.New(http.errors"http.response.status."+typespb.SystemErrorReason_SYSTEM_ERROR_REASON_CAPTCHA_ID_NOT_FOUND.String(), http.StatusBadRequest, "captcha id not found")
)
...
type (
	...
	DepartmentPB = typespb.Department
)
...
type (
	...
	DepartmentsPB = []*typespb.Department
)
...
type (
	...
	UserDepartmentsPB = []*typespb.UserDepartment
)
...
type (
	...
	DepartmentEdgesPB = typespb.DepartmentEdges
)
...
type (
	...
	UserDepartmentPB = typespb.UserDepartment
)
...
type (
	...
	UserDepartmentEdgesPB = typespb.UserDepartmentEdges
)
...
type (
	...
	PermissionsPB = []*typespb.Permission
)
...
type (
	...
	UserPositionsPB = []*typespb.UserPosition
)
...
type (
	...
	PositionEdgesPB = typespb.PositionEdges
)
...
type (
	...
	PermissionPB = typespb.Permission
)
...
type (
	...
	RolePermissionsPB = []*typespb.RolePermission
)
...
type (
	...
	PermissionResourcesPB = []*typespb.PermissionResource
)
...
type (
	...
	PositionPermissionsPB = []*typespb.PositionPermission
)
...
type (
	...
	PermissionEdgesPB = typespb.PermissionEdges
)
...
type (
	...
	UserPositionPB = typespb.UserPosition
)
...
type (
	...
	UserPositionEdgesPB = typespb.UserPositionEdges
)
...
type (
	...
	PositionPermissionPB = typespb.PositionPermission
)
...
type (
	...
	PositionPermissionEdgesPB = typespb.PositionPermissionEdges
)
...
type (
	...
	RolePermissionPB = typespb.RolePermission
)
...
type (
	...
	RolePermissionEdgesPB = typespb.RolePermissionEdges
)
...
type (
	...
	PermissionResourcePB = typespb.PermissionResource
)
...
type (
	...
	PermissionResourceEdgesPB = typespb.PermissionResourceEdges
)
