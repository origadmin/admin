...
// AuthService is a service for identityentication.
...
// NewAuthService creates a new identityentication service.
...
// Login identityenticates a user and returns a token pair.
