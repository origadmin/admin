...
type AdminService struct {
	...
	identityorizer *casbin.Authorizer
	log            *log.Helper
}

// NewAdminService creates a new AdminService.
func NewAdminService(syncer *biz.PolicySyncer, identityorizer *casbin.Authorizer, logger log.Logger) *AdminService {
	return &AdminService{
		syncer:         syncer,
		identityorizer: identityorizer,
		log:            log.NewHelper(log.With(logger, "module", "identity.service.admin")),
	}
}
