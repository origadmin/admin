...
// NewServers creates and configures the identity service servers (gRPC, HTTP, and Watermill).
func NewServers(
	app *runtime.App,
	...
	if len(transportServers) == 0 {
		return nil, errors.New("no servers named 'identity' or 'origadmin.service.identity' were created")
	}
