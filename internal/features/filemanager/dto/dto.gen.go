...
type (
	...
	File                    = ent.File
	FileMetadataPB          = types.FileMetadata
...
// ConvertFileMetadataPBToFile converts FileMetadataPB to File.
func ConvertFileMetadataPBToFile(from *FileMetadataPB) *File {
	if from == nil {
		return nil
	}
...
// ConvertFileToFileMetadataPB converts File to FileMetadataPB.
func ConvertFileToFileMetadataPB(from *File) *FileMetadataPB {
	if from == nil {
		return nil
	}
