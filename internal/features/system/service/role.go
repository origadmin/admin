...
func (s *SystemService) GetRole(ctx context.Context, req *system.GetRoleRequest) (*system.Role, error) {
	return s.role.GetRole(ctx, req.Id)
}
func (s *SystemService) CreateRole(ctx context.Context, req *system.CreateRoleRequest) (*system.Role, error) {
	return s.role.CreateRole(ctx, req.Role)
}
func (s *SystemService) UpdateRole(ctx context.Context, req *system.UpdateRoleRequest) (*system.Role, error) {
