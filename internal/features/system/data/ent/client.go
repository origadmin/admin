...
import (
	...
	"origadmin/application/admin/internal/features/system/data/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Permission, c.PermissionResource, c.Resource, c.Role, c.RolePermission,
		c.User, c.UserRole,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		Permission, PermissionResource, Resource, Role, RolePermission, User,
		UserRole []ent.Hook
	}
	inters struct {
		Permission, PermissionResource, Resource, Role, RolePermission, User,
