...
// NewAuthServiceBiz new Auth use case.
func NewAuthServiceBiz(r runtime.Runtime, repo dto.AuthRepo) *AuthServiceBiz {
	return &AuthServiceBiz{dao: repo, limiter: defaultLimiter, log: log.NewHelper(r.WithLogger("module", "biz/auth"))}
}
