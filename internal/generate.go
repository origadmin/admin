...
//go:generate protoc -I. -I../third_party --go_out=paths=source_relative:../internal ./conf/pb/*.proto
//go:generate protoc -I. -I../third_party --validate_out=paths=source_relative,lang=go:../internal ./conf/pb/*.proto
